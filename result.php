...
?>
 ...
 <a href="doner_pic<?php echo $data[9] ?>"data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[9] ?>" height="100px" width="100px" style="margin:auto; padding-left:70px; padding-right:50px; float:left" /></a></td>
