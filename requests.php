...
<div class="footer">
		<div class="copy">
			<p class="title">Redwan Raj Ratan</p>
		</div>
	<div class="clear"></div>
</div>
</div>
...
if(isset($_POST["sbmt"])) 
{
	...
	$cn=makeconnection();
		$d=$_POST["year"]."/".$_POST["month"]."/".$_POST["day"];
			$s="insert into requestes(name,gender,age,mobile,location,bgroup,email,reqdate,detail) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["t4"] . "','" . $_POST["t6"] ."','" . $_POST["t5"] . "','" . $d .  "','" .  $_POST["t7"]  ."')";
